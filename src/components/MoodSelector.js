...
const MoodSelector = ({ selectedDate, flag , setFlag, darkMode }) => {
                    ...
                    <Row className='text-center'>
                        ...
                        <Col md={12}>
                            <div style={{ width: '70%', margin: 'auto' }}>
                                {/* Emoji Selector */}
                                <div style={{ display: 'flex', justifyContent: 'center', gap: '12px', marginTop: '1rem', marginBottom: '1rem' }}>
                                    {moods.map((mood, idx) => (
                                        <div
                                            key={idx}
                                            style={{
                                                ...
                                                borderRadius: '50%',
                                                backgroundColor: selectedMood === mood.value ? 'transparent' : 'transparent',
